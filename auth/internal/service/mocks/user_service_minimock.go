...
//go:generate minimock -i github.com/MercerMorning/go_example/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, id int64, info *model.UserUpdate) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, info *model.UserUpdate)
...
// GetByEmail implements mm_service.UserService
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, info *model.UserUpdate) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectInfoParam3(info *model.UserUpdate) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.UserUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *model.UserUpdate) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, info *model.UserUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, info *model.UserUpdate) (err error) {
